...
const OurProjects = () => {
  ...
  return (
    <section id="our-projects" className="py-20 bg-gradient-to-b from-white to-gray-50">
          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                {/* CTA Button */}
                <button className="w-full cursor-pointer bg-gradient-to-r from-purple-600 to-blue-600 hover:from-orange-600  text-white font-semibold py-3.5 px-6 rounded-xl transition-all duration-300 flex items-center justify-center gap-2 shadow-md hover:shadow-lg group">
                  READ MORE
